-- Examples of windowing functions for my personal reference
...
-- Demonstrate the Difference Between ROWS and RANGE
...
--Using ROW_NUMBER() to Remove Duplicate Rows
